...
<div class="row row-paddingless">
    {{-- Item --}}
    <div class="col">
        <a href="{{ \App\Providers\RouteServiceProvider::MANAGER }}" class="d-block py-10 px-5 text-center bg-hover-light border-right">
            ...
            <span class="d-block text-dark-50 font-size-lg">{{ \Illuminate\Support\Facades\Auth::user()->company->name }}</span>
        </a>
    </div>
