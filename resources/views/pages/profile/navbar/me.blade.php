...
<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
    ...
    <div class="navi-item mb-2">
        <a href="{{ route('profile_show') }}" class="navi-link py-4
        @if(\Illuminate\Support\Facades\Request::fullUrlIs(route('profile_show')))
         active
        @endif
    ">
...
{{--    Profile Overview--}}
    <div class="navi-item mb-2">
        <a href="{{ route('profile_cards') }}" class="navi-link py-4
        @if(\Illuminate\Support\Facades\Request::fullUrlIs(route('profile_cards')))
            active
        @endif
        ">
            <span class="navi-icon mr-2">
