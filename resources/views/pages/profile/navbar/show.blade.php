...
@if(!\Illuminate\Support\Facades\Request::fullUrlIs(route('user_cards', $user->id)))
        {{--    Personal Information--}}
    <div class="navi-item mb-2">
        <a href="{{ route('profile_show') }}" class="navi-link py-4 active">
...
{{--    Profile Overview--}}
<div class="navi-item mb-2">
    <a href="{{ route('user_cards', $user->id) }}" class="navi-link py-4">
        <span class="navi-icon mr-2">
            <span class="svg-icon">
