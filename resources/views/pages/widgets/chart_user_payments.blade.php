            ...
            <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                <div class="d-flex flex-column mr-2">
                    ...
                    <span class="text-muted font-weight-bold mt-2">
                        Расходы по картам пользователей {{ request()->user()->fullName }}
                    </span>
                </div>
                <span class="symbol symbol-light-success symbol-45">
                    <span class="symbol-label font-weight-bolder font-size-h6">
                        +{{ request()->user()->cards()->payments()->count() }}
                    </span>
                </span>
            </div>
        </div>
        <div class="card-body d-flex flex-column p-0">
            <div id="chart-user-payments" class="card-rounded-bottom" style="height: 150px"></div>
        </div>
    </div>
