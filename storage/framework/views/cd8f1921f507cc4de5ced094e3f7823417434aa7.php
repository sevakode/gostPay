    ...
    <div class="card-body d-flex flex-column p-0">
        <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
            ...
            <span class="symbol symbol-light-success symbol-45">
                <span class="symbol-label font-weight-bolder font-size-h6">+<?php echo e(request()->user()->company->users()->count()); ?></span>
            </span>
        </div>
        <div id="kt_stats_widget_7_chart" class="card-rounded-bottom" style="height: 150px"></div>
    </div>
</div>
<?php /**PATH C:\Users\hd\PhpstormProjects\pay\resources\views/pages/widgets/_widget-3.blade.php ENDPATH**/ ?>