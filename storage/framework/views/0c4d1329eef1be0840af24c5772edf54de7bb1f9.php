            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">
                        <?php echo e(\Illuminate\Support\Facades\Auth::user()->first_name); ?>

                    </span>
                    <span class="symbol symbol-35 symbol-white">
                        <?php if(isset($user->avatarSmall)): ?>
                        <span class="symbol-label font-size-h5 font-weight-bold" style="background-image:url('<?php echo e(asset($user->avatarSmall)); ?>')"></span>
                        <?php else: ?>
                        <span class="symbol-label font-size-h5 font-weight-bold" >
                            <?php echo e(\Illuminate\Support\Facades\Auth::user()->shortname); ?>
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        ...
                        <span class="symbol symbol-35 symbol-light-success">
                            <?php if(isset($user->avatarSmallt)): ?>
                                <span class="symbol-label font-size-h5 font-weight-bold" style="background-image:url('<?php echo e(asset($user->avatarSmall)); ?>')"></span>
                            <?php else: ?>
                                <span class="symbol-label font-size-h5 font-weight-bold" >
                            <?php echo e(\Illuminate\Support\Facades\Auth::user()->shortname); ?>
...
<?php /**PATH C:\Users\hd\PhpstormProjects\pay\resources\views/layout/partials/extras/_topbar.blade.php ENDPATH**/ ?>