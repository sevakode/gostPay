...
eval(" // Class Definition\n" +
    ...
    "" +
    "        if (status == 'Valid') {\n" +
    "           sendAjaxForm('result_form', '#kt_login_signin_form');" +
    "        } else {\n" +
    "          swal.fire({\n" +
    "            text: \"К сожалению, обнаружены ошибки. Повторите попытку.\",\n" +
    "            icon: \"error\",\n" +
    "            buttonsStyling: false,\n" +
    "            confirmButtonText: \"Хорошо, понял!\",\n" +
    "            customClass: {\n" +
    ...
    "          validators: {\n" +
    "            notEmpty: {\n" +
    "              message: 'Имя пользователя требуется'\n" +
    "            }\n" +
    "          }\n" +
    "        },\n" +
    "        last_name: {\n" +
    "          validators: {\n" +
    "            notEmpty: {\n" +
    "              message: 'Фамилия пользователя требуется'\n" +
    "            }\n" +
    "          }\n" +
    "        },\n" +
    "        email: {\n" +
    ...
    "      validation.validate().then(function (status) {\n" +
    "        if (status == 'Valid') {\n" +
    "           sendAjaxForm('dsa', '#kt_login_signup_form')" +
    "        } else {\n" +
    "          swal.fire({\n" +
