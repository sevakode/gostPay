...
class OperationsController extends Controller
{
    ...
    public function notifyOperations(Request $request, $bank, $token)
    {
        $operations = [
            ...
            "-700\n ₽\nТочка ПАО Банка ФК Открытие\nОплата лицензионного вознаграждения за ПК Сервис Точка по тариф.пакету \"Начало\" за период с 01.04.21 по 30.04.21. Согласно Правилам дистанционного обслуживания. НДС не предусмотрен.",
